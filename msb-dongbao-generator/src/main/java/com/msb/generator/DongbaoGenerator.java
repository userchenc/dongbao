...
public class DongbaoGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\IDEAspace\\java\\project\\msb-dongbao-mall-parent\\msb-dongbao-mall-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("晁鹏飞");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3307/dongbao?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.msb.dongbao.ums");//包名
        pc.setEntity("entity");
        pc.setMapper("mapper");
